...
def main():
	...
	if not oArgs.bNoUninstall:
		subprocess.check_call("{} rm -r -f                               {}/bin/device-floater".format(sSudo, sInstallDir).split())
		subprocess.check_call("{} rm -r -f                             {}/share/device-floater".format(sSudo, sInstallDir).split())
		subprocess.check_call("{} rm -r -f    {}/share/icons/hicolor/24x24/apps/device-floater.png".format(sSudo, sInstallDir).split())
		subprocess.check_call("{} rm -r -f    {}/share/icons/hicolor/32x32/apps/device-floater.png".format(sSudo, sInstallDir).split())
		subprocess.check_call("{} rm -r -f    {}/share/icons/hicolor/48x48/apps/device-floater.png".format(sSudo, sInstallDir).split())
		subprocess.check_call("{} rm -r -f {}/share/icons/hicolor/scalable/apps/device-floater.svg".format(sSudo, sInstallDir).split())
		subprocess.check_call("{} rm -r -f  {}/share/applications/com.efanomars.device-floater.desktop".format(sSudo, sInstallDir).split())
		subprocess.check_call("{} rm -r -f                    {}/share/man/man1/device-floater.1.gz".format(sSudo, sInstallDir).split())
