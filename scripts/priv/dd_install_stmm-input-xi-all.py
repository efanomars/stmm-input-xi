...
# File:   dd_install_stmm-input-xi-all.py
...
# In addition to the pk_install_stmm-input-xi-all.py parameters it sets the DESTDIR
...
def main():
	...
	oParser = argparse.ArgumentParser(description="Install all stmm-input-xi projects.\n"
						"  Same as pk_install_stmm-input-xi-all.py but sets DESTDIR environment variable.\n"
	...
	subprocess.check_call("./pk_install_stmm-input-xi-all.py {} {} {} {} {} {} {} {} {} {} {} {}".format(\
