...
# File:   pk_install_stmm-input-xi-all.py
...
# In addition to the install_stmm-input-xi-all.py parameters it sets the STMM_DEBIAN_PACKAGING
...
def main():
	import argparse
	oParser = argparse.ArgumentParser(description="Install all stmm-input-xi projects.\n"
						"  Same as install_stmm-input-xi-all.py but sets STMM_DEBIAN_PACKAGING environment variable\n"
						"  to ON."
	...
	subprocess.check_call("./install_stmm-input-xi-all.py {} {} {} {} {} {} {} {} {} {} {} {}".format(\
