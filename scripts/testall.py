...
def testAll(sBuildType, sInstallDir, sSudo, bBuildStatic, bSanitize):
	...
	subprocess.check_call("./scripts/uninstall_stmm-input-xi-all.py -y --installdir {}  {}".format(sInstallDir, sSudo).split())

	subprocess.check_call("./scripts/install_stmm-input-xi-all.py -b {}  -t On  -d On --docs-to-log  --installdir {}  {} {} {}"\
