...
# TestFiles            Create test executables for a target library from list of source files.
#
# Parameters:
...
#
function(TestFiles STMMI_TEST_SOURCES  STMMI_WITH_SOURCES  STMMI_LINKED_LIBS  STMMI_FAKE_IFACE)
...
#message(STATUS "STMMI_TEST_CUR_FILE     ${STMMI_TEST_CUR_FILE}")
            ...
            add_executable(${STMMI_TEST_CUR_TGT} ${STMMI_TEST_CUR_FILE} ${STMMI_WITH_SOURCES})
            #if (STMMI_WITH_SOURCES_LEN GREATER 0)
